      ...
      <div className="container mx-auto px-4 relative z-10 py-20">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-md font-medium transition-colors"
            >
              Get a Quote <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
            <Link
              to="/products/gi-doors-windows"
              className="inline-flex items-center justify-center bg-white hover:bg-gray-100 text-gray-800 px-6 py-3 rounded-md font-medium transition-colors"
            >
              Explore Products
            </Link>
          </div>
